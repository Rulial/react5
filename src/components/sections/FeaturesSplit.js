          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  A major issue in the service industry for both the clients and vendor is finance/ payment. We are not reinventing the wheel but putting rubber on it, a motor behind it. Summer is a decentralised trading protocol within the ecosystem to make this part of the relationship completely seamless, value based and transparent.
                  </p>
              </div>
              <div className={
                classNames(
