            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Real time workflow is an essential part of our CGI pipeline where by it not only enables better and secure collaboration between talent but also cost savings when building simultaneously for both between narrative and interactive platforms.
                    </p>
                </div>
              </div>
            </div>
